		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="<c:url value='/templates/admin/dist/img/admin-asm.jpg'/>"
							class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
						<a href="#" class="d-block">Duymoiz</a>
					</div>
				</div>
							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td>
											<img alt="Video Poster" src="${item.poster}" width="300px">
										</td>
										<td>
											<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>" class="btn btn-block btn-success btn-sm">Edit</a>
											<button onclick="deleteVideo('${item.href}')" type="button" class="btn btn-block btn-danger btn-sm">Delete</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
